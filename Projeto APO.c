...
void find() {
    ...
    if (registeredSells > 0) {
        ...
        printf("\nNão foram encontradas vendas registradas\n\n");
    }
}
        ...
        switch (choosenParam) {
            case 1:
                ...
                if(searchSell.id <= registeredSells) {
                    ...
                    printf("Não foram encontradas vendas com o id informado");
                }
                break;
            ...
            case 2:
                ...
                if (matchesCounter > 0) {
                    ...
                    printf("Não foram encontradas vendas para o valor informado");
                }
                break;
